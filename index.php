...
<header>
    ...
    <main>
            <div class="featured-div">
                ...
                <div class="flex">
                    <div class="con">
                    <a href="http://localhost/INFOTECH SHOPE./components/store.php#display">
                        <img src="products/ROG Strix XG438Q (PhP 13,159).jpg" alt=""></a>
                        <div>MONITORS</div>
                    </div>

                    <div class="con">
                    <a href="http://localhost/INFOTECH SHOPE./components/store.php#keyboard">
        ...
        <div class="featured-div">
                ...
                <div class="flex">
                    <div class="con">
                    <a href="http://localhost/INFOTECH SHOPE./components/store.php#cables">
                    <img src="products/HAGiBiS 8K HDMI 2_1 Cable (PhP 378).jpg" alt=""></a>
                        <div>CABLES</div>
                    </div>

                    <div class="con">
                    <a href="http://localhost/INFOTECH SHOPE./components/store.php#webcam">
                    <img src="products/Creative 2K Webcam (PhP 800).jpg" alt=""></a>
                        <div>WEBCAMS</div>
                    </div>

                    <div class="con">
                    <a href="http://localhost/INFOTECH SHOPE./components/store.php#flashdrive">
    ...
    <footer class="footer">
                <div class="footer-container">
                    <div class="footer-row">
                        ...
                        <h4>Online shop</h4>
                            <ul>
                                <li><a href="http://localhost/INFOTECH SHOPE./components/store.php#best">Best Sellers</a></li>
                                <li><a href="http://localhost/INFOTECH SHOPE./components/store.php#new">New Items</a></li>
                                <li><a href="http://localhost/INFOTECH SHOPE./components/store.php#display">Display</a></li>
                                <li><a href="http://localhost/INFOTECH SHOPE./components/store.php#keyboard">Mouse and Keyboards</a></li>
                            </ul>
                        </div>
                        <div class="footer-col">
                        <h4>About us</h4>
